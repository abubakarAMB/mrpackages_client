...
PropsType) {
  ...
  const renderImageOrVideo = (product: ProductType) => { 
    //is video if extension is mp4
    const isVideo = product?.productImages && product?.productImages[0].includes('mp4');
    if (!isVideo) {
      return (
